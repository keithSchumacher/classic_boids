...
def generate_sample_2d_data(num_boids=5, num_steps=100, output_file=None):
    """
    Generate sample 2D boid data for testing the animation function.
