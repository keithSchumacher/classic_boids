...
def compute_drives(
    ...
    neighborhoods: dict[DriveName, NeighborhoodProtocol],
    ...
    a_s = drive_functions[DriveName.SEPARATION](neighborhoods[DriveName.SEPARATION], internal_state)
    a_a = drive_functions[DriveName.ALIGNMENT](neighborhoods[DriveName.COHESION], internal_state)
    a_c = drive_functions[DriveName.COHESION](neighborhoods[DriveName.COHESION], internal_state)
    return {
